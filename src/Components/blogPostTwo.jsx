...
import blog3 from "../images/blog_2.webp"
import blog4 from "../images/wpis_2b.webp"

const blogPostTwo = () => {
    return (
        <div className='blogPostOne section'>
            <div className="blogPostImg">
                <img src={blog3} alt="" />
            </div>
            <div className="blogpost-container">
                <div className="blogpost-con">
                    <p className="date">03 March 2026</p>
                    <h1 className='blogpost-title'>What to keep in mind when creating a visual brand identity?</h1>
